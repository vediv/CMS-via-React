      ...
      <Label for="duration" style={{marginTop:'-5px'}}><b>Duration:&nbsp;</b>07:37</Label>
          ...
          <div id="editmodal">
            <Nav tabs  style={{backgroundColor: "#FFFFFF"}} >
              <NavItem>
              <Link to={`/edit_entry/${id}/metadata`}>
                <NavLink
              ...
              <NavItem>
              <Link to={`/edit_entry/${id}/thumbnail`}>
                <NavLink
              ...
              <NavItem>
              <Link to={`/edit_entry/${id}/access_control`}>
                <NavLink
              ...
              <NavItem>
              <Link to={`/edit_entry/${id}/content_partner`}>
                <NavLink
              ...
              <NavItem>
              <Link to={`/edit_entry/1/content_type`}>
                <NavLink
              ...
              <NavItem>
              <Link to={`/edit_entry/${id}/content_rating`}>
                <NavLink
              ...
              <NavItem>
              <Link to={`/edit_entry/${id}/advertisement`}>
                <NavLink
